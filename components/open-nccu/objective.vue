<template>
	<div class="mt-[50vh] snap-center snap-always">
		...
		<div class="text-[80px] flex place-content-evenly">
			...
			<div class="gradient-text">TypeScript</div>
		</div>
		<div class="text-[80px] flex place-content-evenly mt-[1vh]">
			<div class="gradient-text">Vue3.js</div>
			<div class="gradient-text">TailwindCSS</div>
		</div>
...
<script setup>
const hoverOnDownVote = ref(false)
</script>
